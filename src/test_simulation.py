...
def main():
    ...
    # Basic parameters
    num_particles = 5000  # Adjusted to 5,000 particles to reduce computation time

    # Particle parameters
    R_nm_values = np.linspace(10, 100, 10)  # Reduced to 5 values
    R_std_nm = 2  # Std deviation in nm

    # Barrier sizes
    d_nm_values = np.linspace(50, 250, 10)  # Reduced to 5 values

    # Magnetic field strengths
    B_bottom_values = np.linspace(0.1, 0.6, 10)  # Reduced to 5 values
    B_device_values = np.linspace(0.05, 0.6, 10)  # Reduced to 5 values
